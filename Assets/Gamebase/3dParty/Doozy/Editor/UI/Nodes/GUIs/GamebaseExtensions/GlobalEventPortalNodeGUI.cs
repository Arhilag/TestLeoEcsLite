...
namespace Doozy.Editor.UI.Nodes
{
    ...
    [CustomNodeGUI(typeof(GlobalEventPortalNode))]
    public class GlobalEventPortalNodeGUI : BaseNodeGUI
    {
        ...
        private GlobalEventPortalNode TargetNode { get { return (GlobalEventPortalNode) Node; } }
        ...
        private Styles.StyleName WaitForActionIconStyleName => Styles.StyleName.IconGameEventListener;
